			...
			<?php 
				 while($arreglo=mysqli_fetch_array($query)){
				  	echo "<tr class='success'>";
				    	...
				    	echo "<td><a href='actualizar1.php?id=$arreglo[0]'><img src='images/actualizar.gif' class='img-rounded'></td>";
						echo "<td><a href='admin1.php?id=$arreglo[0]&idborrar=2'><img src='images/eliminar.png' class='img-rounded'/></a></td>";
				...
				echo "</table>";
					...
					if(@$idborrar==2){
						...
						$sqlborrar="DELETE FROM Producto WHERE id_producto='$id'";
