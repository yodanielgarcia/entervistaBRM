...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
		...
		$sql="SELECT * FROM marca WHERE nombre='$id'";
	//la variable  $mysqli viene de connect_db que lo traigo con el require("connect_db.php");
		...
		<form action="ejecutaactualizar.php" method="post">
				Nombre<br><input type="text" name="id" value= "<?php echo $id ?>" readonly="readonly"><br>
				referencia<br> <input type="text" name="user" value="<?php echo $user?>"><br>
				<br>
